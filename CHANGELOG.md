...
## [2.09] - 2025-12-15
### Added
- If PCToBCExchangeRate is zero, set it to 1.0 to fix proper currency conversion rate
- Error/Waring reporting

### Fixed
- Trace log for import filesize data for Application Insights
